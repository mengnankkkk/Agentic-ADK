...
import com.alibaba.langengine.amap.sdk.request.IpLocationRequest;
...
import com.alibaba.langengine.amap.sdk.response.IpLocationResponse;
...
import static com.alibaba.langengine.amap.sdk.AMapConstant.IP_LOCATION_API_ENDPOINT;
...
public class AMapClient {
	...
	/**
	 * Use AMap API to Location Search. (Full Request) Doc:
	 * <a href="https://lbs.amap.com/api/webservice/guide/api-advanced/search#s0">...</a>
	...
	/**
	 * Use AMap API to Location Search. (Simple Request) Doc:
	 * <a href="https://lbs.amap.com/api/webservice/guide/api-advanced/search#s0">...</a>
	 ...
	 * @throws AMapException when API call fails
	 */
	public IpLocationResponse getIpLocation(IpLocationRequest request) throws AMapException {
		try {
			HttpUrl.Builder urlBuilder = HttpUrl.parse(AMAP_API_URL + IP_LOCATION_API_ENDPOINT).newBuilder();
			...
			if (request.getSig() != null) {
				urlBuilder.addQueryParameter("sig", request.getSig());
			}
			...
			throw new AMapException("Error occurred while calling Amap IP location API", e);
		}
		catch (Exception e) {
			throw new AMapException("Unexpected error occurred while calling Amap IP location API", e);
		}
	}
	 ...
	 * @throws AMapException when API call fails
	 */
	public IpLocationResponse getIpLocation(String ip) throws AMapException {
